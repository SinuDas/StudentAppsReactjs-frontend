...
savedata() {
  ...
  //function for validation and save data
...
<div className="container">
  <div className="row">
     ...
     <div></div>     
        <div className="submit-form">     
           ...
           {this.state.hasdd && <span><h5 className="errors">Data Submitted Successfully</h5></span>}
            ...
            <div className="form-group">
              ...
              <input type="date" className="form-control" id="name" name="dob" autocomplete="off" required
                   value={this.state.dob} pattern="[a-zA-Z0-9\s]+"
                   onChange={this.onChangedob}/>
            </div>            
            <div className="form-group">
               <label htmlFor="class">Class</label>
               <select value={this.state.classes} onChange={this.OnChangeclasses}name="classes" id="name" className="sidv" autocomplete="off">             
        ...
        <button onClick={()=> {this.savedata();this.refreshPage();}} className="btn btn-success" >Submit</button>
